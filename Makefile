...
SOURCES       = main.cpp \
		...
		tester.cpp \
		open_close_test.cpp \
		pack_by_char_test.cpp moc_mainwindow.cpp
OBJECTS       = main.o \
		mainwindow_init.o \
		mainwindow.o \
		simpletest.o \
