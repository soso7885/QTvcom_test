...
SOURCES       = main.cpp \
		...
		port_behavior.cpp \
		tester.cpp \
		reconn_test.cpp moc_mainwindow.cpp
OBJECTS       = main.o \
		mainwindow.o \
		simpletest.o \
		button.o \
...
reconn_test.o: reconn_test.cpp mainwindow.h \
		/usr/include/qt5/QtWidgets/QMainWindow \
		/usr/include/qt5/QtWidgets/qmainwindow.h \
		/usr/include/qt5/QtWidgets/qwidget.h \
		/usr/include/qt5/QtGui/qwindowdefs.h \
		...
		/usr/include/qt5/QtGui/QBrush \
		ui_mainwindow.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o reconn_test.o reconn_test.cpp
